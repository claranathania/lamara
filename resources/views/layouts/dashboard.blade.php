...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="{{ url('js/fontawesome-free/css/all.min.css') }}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
     <img src="{{ url('img/logo.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle " width="90" > lamara
          <style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">halo</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
